...
<TagGenerator /> + function Generate(this: TagGenerator & IGenerator)
{
    this.TraverseTag(this.m_Tag);
    return this.m_Fragments.join("");
};

<TagGenerator /> + function TraverseTag(this: TagGenerator & IGenerator, tag: NodePath<JSXElement>)
{
...
<TagGenerator /> + function Append(this: TagGenerator, fragment: string)
{
    this.m_Fragments.push(fragment);
};

<TagGenerator /> + function TraverseText(this: TagGenerator & IGenerator, text: NodePath<JSXText>)
{
...
<TagGenerator /> + function constructor(this: TagGenerator, tag: NodePath<JSXElement>)
{
    this.m_Tag = tag;
    this.m_Fragments = [];
}